'''
@Author: Ariprasath
@Date: 2021-09-11 13:52:30
@Last Modified by: Ariprasath
@Last Modified time: 2021-09-11 14:28:00
@Title : calculates the sum of all the members in a list
'''
...
def sum_members(sample_data):
    '''
    Description:
        Sums all the members in the list
    Parameter:
        sample_data(list): contains integer values
    Return:
        sum(int): sum of all the members in the given list
    Raises:
...
if __name__=="__main__":
    ...
    # sample_data=[]
    try:
        print(f"sum-->{sum_members(sample_data)}")
